...
use crate::{
    entity::{
        ...
        mob::{
            ...
            drowned::DrownedEntity, elder_guardian::ElderGuardianEntity, enderman::EndermanEntity,
            endermite::EndermiteEntity, evoker::EvokerEntity, ghast::GhastEntity,
            giant::GiantEntity, guardian::GuardianEntity, hoglin::HoglinEntity, husk::HuskEntity,
            illusioner::IllusionerEntity, magma_cube::MagmaCubeEntity, phantom::PhantomEntity,
            piglin::PiglinEntity, piglin_brute::PiglinBruteEntity, pillager::PillagerEntity,
            ravager::RavagerEntity, shulker::ShulkerEntity, silverfish::SilverfishEntity,
            slime::SlimeEntity, spider::SpiderEntity, stray::StrayEntity, vex::VexEntity,
            vindicator::VindicatorEntity, warden::WardenEntity, witch::WitchEntity,
            wither_skeleton::WitherSkeletonEntity, zoglin::ZoglinEntity, zombie::ZombieEntity,
            zombie_villager::ZombieVillagerEntity, zombified_piglin::ZombifiedPiglinEntity,
        },
        passive::{
            allay::AllayEntity, armadillo::ArmadilloEntity, axolotl::AxolotlEntity, bat::BatEntity,
            bee::BeeEntity, camel::CamelEntity, cat::CatEntity, chicken::ChickenEntity,
            cod::CodEntity, cow::CowEntity, dolphin::DolphinEntity, donkey::DonkeyEntity,
            fox::FoxEntity, frog::FrogEntity, goat::GoatEntity, horse::HorseEntity,
            iron_golem::IronGolemEntity, llama::LlamaEntity, mooshroom::MooshroomEntity,
            mule::MuleEntity, ocelot::OcelotEntity, panda::PandaEntity, parrot::ParrotEntity,
            pig::PigEntity, polar_bear::PolarBearEntity, pufferfish::PufferfishEntity,
            rabbit::RabbitEntity, salmon::SalmonEntity, sheep::SheepEntity,
            skeleton_horse::SkeletonHorseEntity, sniffer::SnifferEntity,
            snow_golem::SnowGolemEntity, squid::SquidEntity, strider::StriderEntity,
            tadpole::TadpoleEntity, trader_llama::TraderLlamaEntity,
            tropical_fish::TropicalFishEntity, turtle::TurtleEntity, wolf::WolfEntity,
            zombie_horse::ZombieHorseEntity,
        },
    },
    world::World,
};

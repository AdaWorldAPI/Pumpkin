...
/// Magma Cube — a Nether variant of the Slime that is fire-immune and bounces.
///
/// Currently has basic AI. Splitting on death is a future addition.
...
impl MagmaCubeEntity {
    pub async fn new(entity: Entity) -> Arc<Self> {
        ...
        let magma_cube = Self { mob_entity };
        let mob_arc = Arc::new(magma_cube);

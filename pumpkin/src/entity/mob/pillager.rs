...
use crate::entity::{
    ...
    ai::goal::{
        ...
        look_at_entity::LookAtEntityGoal, ranged_attack::RangedAttackGoal, swim::SwimGoal,
        wander_around::WanderAroundGoal,
    },
    mob::{Mob, MobEntity},
};

/// Pillager — an illager armed with a crossbow.
///
/// Currently has basic AI: targets players, wanders, looks around.
/// Crossbow attack behavior is a future addition.
...
impl PillagerEntity {
    pub async fn new(entity: Entity) -> Arc<Self> {
...

        {
            ...
            goal_selector.add_goal(3, RangedAttackGoal::new(1.0, 20, 8.0));

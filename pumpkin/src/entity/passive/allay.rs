...
/// Allay — a friendly flying mob that collects items.
///
/// Currently has basic AI: panics on damage, wanders, looks at players.
/// Item collection and note block dancing are future additions.

...
use crate::entity::{
    Entity, NBTStorage,
    ai::goal::{
        breed, flee_entity::FleeEntityGoal, follow_parent, look_around::LookAroundGoal,
...
/// Rabbit — a small passive mob that hops around.
///
/// Rabbits panic when hit and wander randomly.
...
impl RabbitEntity {
    pub async fn new(entity: Entity) -> Arc<Self> {
...

        {
            ...
            goal_selector.add_goal(2, FleeEntityGoal::new(&EntityType::WOLF, 10.0, 2.2, 2.2));
            goal_selector.add_goal(3, tempt::TemptGoal::new(1.0, tempt::TEMPT_RABBIT, 10.0));

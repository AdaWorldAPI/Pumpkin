...
/// Armadillo — a passive mob that drops scutes when brushed.
///
/// Currently has basic AI: swims, panics, wanders, looks at players.
/// Rolling into a ball and scute drops are future additions.
...
impl ArmadilloEntity {
    pub async fn new(entity: Entity) -> Arc<Self> {
...

        {
            ...
            goal_selector.add_goal(3, tempt::TemptGoal::new(1.2, tempt::TEMPT_ARMADILLO, 10.0));
